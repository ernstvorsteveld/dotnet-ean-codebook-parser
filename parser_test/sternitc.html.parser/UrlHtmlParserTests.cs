    ...
    public class UrlHtmlParserTests
    {
        ...
        public void should_load_html_page()
        {
            ...
            results.Should().SatisfyRespectively(
                first => { first.Get("EAN code aansluiting").Should().Be("871688540030933384"); },
                second => { second.Get("EAN code aansluiting").Should().Be("871688540004448586"); }
            );
        }
